...
function Signup() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setTimeout(() => navigate('/login'), 1500); // Delay navigation for success message visibility
        } catch (err) {
        ...
        <div className="signup-container">
            ...
            <form onSubmit={handleSubmit}>
                <div className="input-group">
                    <label className="slabel" htmlFor="firstname">First Name</label>
                    <input
                        className="sinput"
                        type="text"
                        id="firstname"
                ...
                <div className="input-group">
                    <label className="slabel" htmlFor="lastname">Last Name</label>
                    <input
                        className="sinput"
                        type="text"
                        id="lastname"
