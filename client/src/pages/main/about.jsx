        ...
        <div className="about-container">
            ...
            <section className="flex-container">
                ...
                <div className="values">
                    ...
                    <div className="box">
                        <ul className="uli">
                            <li style={{ '--i': 1 }}>Decent conscience and good heart</li>
                            <li style={{ '--i': 2 }}>An limitless thirst for learning</li>
                            <li style={{ '--i': 3 }}>Love of work and dedication</li>
                            <li style={{ '--i': 4 }}>Unlimited thought and imagination</li>
                            <li style={{ '--i': 5 }}>A foundation for generations</li>
                        </ul>
                    </div>
                </div>
                ...
                <div className="philosophy">
                    ...
                    <div className="box">
                        <ul className="uli">
                            <li style={{ '--i': 1 }}>Knowledge is wealth</li>
                            <li style={{ '--i': 2 }}>We acknowledge new ideas</li>
                            <li style={{ '--i': 3 }}>Diligence is the power of positive change</li>
                            <li style={{ '--i': 4 }}>Technology and innovation is the language of the new generation</li>
                            <li style={{ '--i': 5 }}>Encouraging innovation for the next generation</li>
                            <li style={{ '--i': 6 }}>Modern digital economy is the basis of our development</li>
                        </ul>
                    </div>
                </div>
            </section>
